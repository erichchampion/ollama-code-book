...
if (process.platform === 'win32') {
  console.error('\x1b[31m%s\x1b[0m', 'Error: Ollama Code is not supported on Windows.');
  console.error('\x1b[33m%s\x1b[0m', 'Ollama Code requires macOS or Linux to run properly.');
  ...
  console.error('\x1b[33m%s\x1b[0m', 'Please visit https://github.com/ollama/ollama for troubleshooting information.');
  process.exit(1);
}
...
if (parseInt(nodeMajorVersion, 10) < 18) {
  console.error('\x1b[31m%s\x1b[0m', 'Error: Ollama Code requires Node.js version 18 or higher.');
