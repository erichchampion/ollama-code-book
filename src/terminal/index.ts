...
class Terminal implements TerminalInterface {
  ...
  displayWelcome(): void {
    ...
    console.log(chalk.white(`  You can ask Ollama to explain code, fix issues, or perform tasks.`));
    console.log(chalk.white(`  Example: "${chalk.italic('Please analyze this codebase and explain its structure.')}"\n`));

    if (this.config.useColors) {
      console.log(chalk.dim('  Pro tip: Use Ctrl+C to interrupt Ollama and start over.\n'));
    }
  }
